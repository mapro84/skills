...
class Hint {
  ...
  public function getFactory($key)
  {
    ...
    public function getFactory__new($key) {
        if(isset($this->instances[$key])) {
            return($this->instances[$key]);
        }
        else {
...
//   /**
//    * @param mixed $key
//    * @return mixed callable function
//    */
...
//           $this->instances[$key] = $reflected_class->newInstance();
//         }else{
//           throw new \ErrorException('Class '.$key.' is not an instanciable class');
//         }
...
//   /**
//    * Factory return a different instance for each call
//    * @param mixed $key
